...
<head>
    <title>Xoá sản phẩm - Laptopshop Admin</title>
...
<body class="ls-admin">
    ...
    <main class="la-main">
        <header class="la-page-head">
            <div>
                <h1 class="la-page-head__title">Xoá sản phẩm #${id}</h1>
                <p class="la-page-head__desc">Xác nhận việc xoá sản phẩm khỏi cửa hàng</p>
            </div>
        </header>
        ...
        <div class="ui-card" style="max-width: 560px; padding: var(--space-6);">
            <div class="ui-alert ui-alert--danger" style="margin-bottom: var(--space-4);">
                ...
                <span>Bạn chắc chắn muốn xoá sản phẩm này? Hành động này không thể hoàn tác.</span>
            </div>
            <form:form method="post" action="/admin/product/delete" modelAttribute="newProduct">
                ...
                <div style="display:flex; gap: var(--space-3);">
                    ...
                    <a href="/admin/product" class="ui-btn ui-btn--ghost">Huỷ</a>
                </div>
            </form:form>
        </div>
